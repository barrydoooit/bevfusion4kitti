...
class BEVFusionSparseEncoder(SparseEncoder):
    ...
    def __init__(self,
        ...
        self.rule_book_reuse = rule_book_reuse
    ...
    def forward(self, voxel_features, coors, batch_size):
        ...
        # https://github.com/mit-han-lab/bevfusion/issues/87
        # D is for z (vertical) axis
        # https://blog.csdn.net/weixin_38362784/article/details/124520240
        # W is for x and H is for y d, but seems reversed here
        N, C, H, W, D = spatial_features.shape
        spatial_features = spatial_features.permute(0, 1, 4, 2, 3).contiguous()
        spatial_features = spatial_features.view(N, C * D, H, W) # x, y, orginal should be y, x, that's probably why transfusion head heatmap is using center[[1, 0]] to draw
                    ...
                    if j == len(blocks) - 1 and i != len(
                        ...
                        blocks_list.append(
                            SparseBasicBlock(
                                ...
                                norm_cfg=norm_cfg,
                                conv_cfg=None,
                                indice_key=f'subm{i + 1}' if self.rule_book_reuse else None))
                else:
                    blocks_list.append(
                        make_block(
                            in_channels,
